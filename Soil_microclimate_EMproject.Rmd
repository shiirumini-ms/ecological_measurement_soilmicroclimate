---
title: 'Appendix. C: Summary of R code used in statistical analyses and visualisation.
  R version 4.5.1.'
author: "Mako Shibata"
output:
...
# p = 0.03 for mound, p = 0.34 for no-mound.
...
table_obj <- tidy(no_mound_aov)
pander(no_mound_aov, digits = 3)
# p = 0.18 for mound, p = 0.04 for no-mound. 
# df = 24 and df = 24 respectively.
